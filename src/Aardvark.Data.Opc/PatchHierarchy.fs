...
type PatchHierarchy with
    ...
    member this.kdTreeN_FileAbsPath =
        this.kdTreeAgg_FileAbsPath -1 ViewerModality.XYZ

    member this.kdTreeN2d_FileAbsPath =
        this.kdTreeAgg_FileAbsPath -1 ViewerModality.SvBR

    member this.kdTreeAggZero_FileAbsPath =
        this.kdTreeAgg_FileAbsPath 0 ViewerModality.XYZ

    member this.kdTreeAggZero2d_FileAbsPath =
        this.kdTreeAgg_FileAbsPath 0 ViewerModality.SvBR